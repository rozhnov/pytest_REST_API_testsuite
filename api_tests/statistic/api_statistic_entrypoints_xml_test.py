...
def setup_module():
    ...
    sender = Sender()
    request = sender.get("/api/rest/webmaster/xml/statistics-entrypoints/points_types/2014-12-01/2014-12-20?")
...
def test_statistic_entrypoints_xml_status():
    assert code == 200
...
def test_statistic_entrypoints_xml_data():
