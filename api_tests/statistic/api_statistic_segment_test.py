...
def setup_module():
    ...
    sender = Sender()
    request = sender.get("/api/rest/webmaster/json/statistics-segments/type_offers/2014-06-15/2014-06-20?")
...
def test_statistic_segment_json_schema():
    validate(jsondump, schema)


def test_statistic_segment_json_status_500():
