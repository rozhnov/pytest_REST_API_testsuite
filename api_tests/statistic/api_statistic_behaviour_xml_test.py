...
def setup_module():
    ...
    sender = Sender()
    request = sender.get("/api/rest/webmaster/xml/statistics-behaviour/new_user/2014-06-15/2014-06-20?")
...
def test_statistic_behaviour_xml_status():
    assert code == 200
...
def test_statistic_behaviour_xml_data():
